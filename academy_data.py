...
MODULES = [
  ...
  },
  {
    ...
    "quiz": [ {"q": "What does dynamic propeller balancing use to identify out-of-balance conditions?", "choices": ["A visual inspection only", "Electronic vibration analysis equipment with the engine running", "Static weighing on a bench", "Sound level meters"], "answer": 1, "explain": "Dynamic balancing uses vibration analysis equipment while the engine runs to detect and correct out-of-balance conditions that static balancing alone cannot catch."},
