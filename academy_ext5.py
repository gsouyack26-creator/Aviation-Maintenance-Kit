...
EXT5_MODULES = [
  ...
  },
  {
    ...
    "sections": [
      ...
      {"heading": "Oxygen System Servicing Precautions", "body": "Oxygen systems demand scrupulous cleanliness - oil, grease, or hydraulic fluid contacting high-pressure oxygen can ignite violently. Only oxygen-clean tools and components rated for oxygen service may be used, fittings are torqued per the AMM (never over-tightened), and servicing carts are bonded/grounded before connecting. Slowly crack open valves to avoid rapid compression heating (adiabatic heating) inside the line, which can ignite trace contamination. No smoking, open flame, or unauthorized electrical equipment near oxygen servicing."}
    ],
    "quiz": [
      {"q": "Why must oxygen system valves be opened slowly during servicing?", "choices": ["To save oxygen", "Rapid compression can cause adiabatic heating that ignites contamination", "It is faster", "To reduce noise"], "answer": 1, "explain": "Opening an oxygen valve quickly compresses gas rapidly downstream, generating heat (adiabatic heating) that can ignite trace oil/grease contamination."},
  ...
  },
  {
    ...
    "sections": [
      ...
      {"heading": "Hot Start and No-Start Troubleshooting", "body": "A hot start (ITT/EGT exceeding limits during start) is usually caused by excess fuel flow during light-off, a weak igniter delaying combustion, or insufficient starter cranking speed. A no-start with fuel and ignition present but no light-off often points to a fuel nozzle spray pattern problem, an igniter gap that is fouled or worn, or incorrect start-fuel scheduling by the FADEC/fuel control. Any hot start event requires a borescope inspection of the hot section per the engine manual before the next flight."}
    ],
    "quiz": [
      {"q": "A turbine engine that exceeds ITT limits during start (hot start) requires:", "choices": ["Nothing, it is normal", "A borescope inspection of the hot section before further flight", "Only a logbook note", "Replacing the battery"], "answer": 1, "explain": "A hot start can damage hot-section components; the engine manual requires a borescope inspection before the engine flies again."},
  ...
  },
  {
    ...
    "sections": [
      ...
      {"heading": "Instrument Discrepancy Troubleshooting", "body": "When an engine instrument reads outside expected range, first rule out the instrument/sender itself before condemning the engine: swap or bench-test the sender/transducer, check wiring continuity and grounds, and compare against a second independent indication if available (e.g., compare EGT probe reading against a borescope-observed condition). A rapidly fluctuating gauge often indicates a loose connector or intermittent sensor ground rather than an actual engine problem, while a slow drift over many flight hours is more likely a true sensor calibration or engine-condition change."}
    ],
    "quiz": [
      {"q": "A rapidly fluctuating (needle jumping) engine gauge reading is most often caused by:", "choices": ["A serious internal engine failure", "A loose connector or intermittent ground in the sensing circuit", "Normal operation", "Low oil pressure"], "answer": 1, "explain": "Erratic, rapid fluctuation is a classic symptom of a loose electrical connection or intermittent ground, not a true engine condition change."},
  ...
  },
  {
    ...
    "sections": [
      ...
      {"heading": "Weld Inspection and Common Defects", "body": "After welding an aircraft component, inspect for undercut (a groove melted into base metal at the weld toe, reducing thickness), porosity (gas bubbles trapped in the weld, seen as small holes on the surface or via X-ray), and incomplete fusion (weld metal didn't properly bond to base metal). A dye-penetrant check after welding helps reveal surface cracking that visual inspection alone can miss. Any structural weld repair must be performed per approved data with the correct filler rod and post-weld stress relief where specified - welding is not acceptable on many primary structure components without specific engineering approval."}
    ],
    "quiz": [
      {"q": "Porosity in a weld appears as:", "choices": ["Extra weld strength", "Small gas-bubble holes trapped in the weld metal", "A discoloration only", "Correct penetration"], "answer": 1, "explain": "Porosity is trapped gas forming small voids/holes in the weld, which weakens it and is checked for visually and via X-ray."},
