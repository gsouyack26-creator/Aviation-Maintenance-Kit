...
EXT3_MODULES = [
  ...
  },
  {
    ...
    "sections": [
      ...
      {"heading": "Building Your A&P Career", "body": "Most mechanics start in general aviation or a Part 145 repair station to build broad hands-on experience, then specialize (avionics, structures, powerplant, or NDT) or move to Part 121 airline heavy maintenance for depth on specific fleet types. Documenting logged experience carefully matters - the FAA's practical test and later an Inspection Authorization (IA) both require verifiable experience records. Continuing education (type-specific factory schools, NDT Level II/III certification, avionics/electrical specialty courses) increases both pay and job mobility throughout a career."}
    ],
    "quiz": [
      {"q": "Why is careful documentation of logged maintenance experience important early in an A&P career?", "choices": ["It is not important", "It is required for later credentials like an Inspection Authorization (IA)", "Only for tax purposes", "It replaces the practical test"], "answer": 1, "explain": "Verifiable, well-documented experience is required for advanced credentials such as an Inspection Authorization (IA)."},
  ...
  },
  {
    ...
    "sections": [
      ...
      {"heading": "Composite Damage Assessment", "body": "Composite damage is assessed differently than metal: a coin-tap test (tapping with a coin or small hammer and listening for a dull thud versus a sharp ring) can reveal subsurface delamination invisible from the surface. Impact damage often causes a small visible dent but a much larger internal delamination zone, so damage must be mapped with ultrasonic or tap-test methods before repair, not just measured visually. Repairs must use the specified resin system and cure schedule (temperature/time/pressure) from the structural repair manual - mismatched resin systems or improper cure can leave a repair far weaker than it appears."}
    ],
    "quiz": [
      {"q": "A coin-tap test on a composite panel is used to detect:", "choices": ["Paint color mismatch", "Subsurface delamination not visible from the surface", "Fuel leaks", "Electrical bonding"], "answer": 1, "explain": "A dull thud versus a sharp ring when tap-testing reveals hidden subsurface delamination in composite structure."},
  ...
  },
  {
    ...
    "sections": [
      ...
      {"heading": "Ice Protection System Checks", "body": "Pneumatic deicer boots are checked for cracks, disbonding, and proper cyclic inflation timing during ground tests; a boot that fails to inflate fully or stays inflated too long disrupts the ice-shedding cycle. Electrothermal (heated) leading edges and prop anti-ice boots are checked with an ammeter for correct current draw per zone - a zone drawing zero or excessive current indicates an open or shorted heating element. Pitot heat and windshield anti-ice are functionally checked before every flight into known icing conditions."}
    ],
    "quiz": [
      {"q": "An electrothermal wing anti-ice zone showing zero current draw during a functional check indicates:", "choices": ["Normal operation", "An open circuit or failed heating element in that zone", "Excess ice buildup", "A full fuel tank"], "answer": 1, "explain": "Zero current draw in a heated zone means the circuit is open or the heating element itself has failed."},
  ...
  },
  {
    ...
    "sections": [
      ...
      {"heading": "Overhaul Decision Factors", "body": "Beyond reaching the manufacturer's recommended TBO (time between overhaul), an engine may need overhaul earlier due to a prop strike, sudden stoppage, over-temperature/over-boost event, metal found in the oil filter/screen, or a documented sudden loss of power. TBO itself is a recommendation (not usually mandatory for Part 91 operators) but is typically mandatory for Part 135/121 operations per their approved maintenance program. Engine logbooks and oil analysis trends over time are reviewed together with calendar time and cycles to make an informed overhaul-timing decision."}
    ],
    "quiz": [
      {"q": "Which event would typically require an engine teardown/inspection regardless of accumulated hours since the last overhaul?", "choices": ["A routine oil change", "A sudden prop strike or sudden stoppage event", "Normal cruise flight", "A tire replacement"], "answer": 1, "explain": "A prop strike or sudden stoppage can cause internal damage (bent crankshaft, gear train shock) that requires teardown inspection regardless of hours remaining to TBO."},
