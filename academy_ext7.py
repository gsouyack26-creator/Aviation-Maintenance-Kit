...
EXT7_MODULES = [
  {
    ...
    "sections": [
      ...
      {"heading": "Calibration and Measurement Discipline", "body": "Precision tools (torque wrenches, micrometers, calipers, dial indicators) require periodic calibration traceable to a recognized standard, with a calibration due-date sticker/tag visible on the tool - using an out-of-calibration tool invalidates the measurement and can lead to under/over-torqued fasteners or incorrect fit-up decisions. Zero a micrometer or dial indicator before each use, and check for consistent readings (repeat the measurement) rather than trusting a single reading, especially near tolerance limits where a small measurement error changes an accept/reject decision."}
    ],
    "quiz": [
      {"q": "Using a torque wrench that is past its calibration due date can result in:", "choices": ["No consequence at all", "Under- or over-torqued fasteners, since the measurement can no longer be trusted", "Faster work only", "Better accuracy"], "answer": 1, "explain": "An out-of-calibration torque wrench may not apply the actual torque value shown, risking improperly torqued fasteners."},
  ...
  },
  {
    ...
    "sections": [
      ...
      {"heading": "Rigging Verification and Cable Tension", "body": "After any control system work, rigging must be verified against the AMM: control surface travel (measured with a protractor/rigging fixture at specified deflection angles), cable tension (measured with a calibrated tensiometer, temperature-corrected since cables expand/contract), and full free movement without binding through the entire range including at the control column/wheel stops. A cable that is over-tensioned accelerates pulley/fitting wear; under-tensioned cables can slip on pulleys or produce sloppy control response - both are checked and adjusted at turnbuckles per the rigging chart."}
    ],
    "quiz": [
      {"q": "Why is cable tension measured with temperature correction during flight control rigging?", "choices": ["It is not necessary", "Cables expand and contract with temperature, affecting the tension reading", "Only for hydraulic systems", "Temperature affects paint color"], "answer": 1, "explain": "Cable tension changes with temperature due to thermal expansion/contraction, so rigging charts specify temperature-corrected tension values."},
  ...
  },
  {
    ...
    "sections": [
      ...
      {"heading": "Fire Detection System Testing", "body": "Fire/overheat detection loops (continuous-loop or spot detectors) are functionally tested per the AMM using a test switch that simulates a fire condition electrically - a system that fails to alert during this test, or that alerts falsely without a test input, must be isolated and repaired before flight since a false-negative (no warning during real fire) or false-positive (nuisance warnings leading crews to distrust the system) are both dangerous. Continuity and insulation resistance of the detector loop wiring itself should be checked when troubleshooting an intermittent fault, since chafed or corroded loop wiring is a common root cause."}
    ],
    "quiz": [
      {"q": "A fire detection loop that gives frequent false (nuisance) warnings is dangerous mainly because:", "choices": ["It uses more electricity", "It can cause crews to distrust and disregard a genuine warning", "It looks bad in the logbook", "It has no real consequence"], "answer": 1, "explain": "Frequent false warnings erode crew confidence in the system, risking a genuine fire warning being disregarded or delayed in response."},
  ...
  },
  {
    ...
    "sections": [
      ...
      {"heading": "Governor Troubleshooting", "body": "A propeller that hunts (RPM oscillates rather than staying steady) usually indicates a governor with excessive internal wear, incorrect speeder spring tension, or air/contamination in the governor oil supply. Failure to feather on a constant-speed prop points to a stuck feathering valve, low oil pressure, or an counterweight/spring linkage binding. Always verify governor oil pressure and prop control cable rigging travel before condemning the governor itself, since a rigging problem can mimic a governor fault."}
    ],
    "quiz": [
      {"q": "A constant-speed propeller that 'hunts' (RPM oscillates) most likely has:", "choices": ["A perfectly functioning governor", "Excessive governor wear, incorrect speeder spring tension, or contaminated governor oil", "Too much fuel", "A cracked windshield"], "answer": 1, "explain": "Hunting is a classic symptom of governor wear, incorrect spring tension, or oil contamination/aeration affecting governor response."},
